    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_photo', models.ImageField(upload_to='services/photos/', verbose_name='Фото')),
                ('kind_of_activity', models.CharField(max_length=150, verbose_name='Вид деятельности')),
            ],
        ),
        migrations.CreateModel(
            name='ServiceHashtag',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, verbose_name='Хештег')),
